    ...
    >
      <div className="flex items-center justify-between">
        ...
        {department.OfficialPage && (
          <a href={department.OfficialPage} target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:text-blue-800 flex items-center gap-1 transition-colors duration-200">
      ...
      {department.HOD && (
        <div className="flex items-center gap-2 text-gray-600">
          <Building2 size={16} /><span>HOD: {department.HOD}</span>
        </div>
      )}
